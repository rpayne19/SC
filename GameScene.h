...
@interface GameScene : AbstractScene {
    ...
    BOOL waterDamage[kMax_Map_Width][kMax_Map_Height];
	...
	CGRect YbuttonBounds;						// Holds the bounds used to check for a touch of the pause button
	CGRect XbuttonBounds;
    CGRect BbuttonBounds;
    CGRect AbuttonBounds;
	...
	Image *pauseButton;									// Pause button in HUD
    ...
    float sockDelta;
    int alertCounter;
    int continues;                              //Number of times player dies/continues
    int alertCounts;                            //Number of times player enters alert mode
    int waterDeaths;
    float alertStateDelta;
}

@property (nonatomic, retain) TiledMap *sceneTileMap;
@property (nonatomic, retain) Player *player;
@property (nonatomic, retain) Mouse *playerMouse;
...
@property (nonatomic, assign) BOOL hasMouse;
@property (nonatomic, assign) int alertCounter;
