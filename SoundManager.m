...
- (NSUInteger)playSoundWithKey:(NSString*)aSoundKey {
	return [self playSoundWithKey:aSoundKey gain:1.0f pitch:1.0f location:CGPointMake(240, 160) shouldLoop:NO]; //was (0,0) changed because of longcat problem with sound
}
