...
@interface Player : AbstractEntity {
    ...
    Animation *upLongCat;
    Animation *rightLongCat;
    Animation *downLongCat;
    Animation *leftLongCat;
    Animation *socksAnimation;
...
@property (nonatomic, assign) CGPoint checkPointLocation;
