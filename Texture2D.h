...
@private
	...
	GLint width;		// The actual width and height of the texture once it has been adjusted to be
	GLint height;		// power of 2 compliant
...
@property(nonatomic, readonly) GLint width;           //CHANGED from NSInteger
@property(nonatomic, readonly) GLint height;          //CHANGED from NSInteger
